  ...
  return (
    <section className="bg-[#F1F1F1] -mt-40 dark:bg-gray-900 pb-40">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col items-center justify-between mx-10 md:pt-40">
          <h1 className="my-20 text-6xl font-bold text-center text-gray-500 lg:text-9xl md:my-0 dark:text-gray-600 lg:text-left">
            Latest Code
          </h1>
      ...
      <div className="grid max-w-6xl grid-cols-1 gap-8 px-10 mx-auto md:grid-cols-2 lg:grid-cols-3 gap-y-20">
        {/* Single github Repo */}
